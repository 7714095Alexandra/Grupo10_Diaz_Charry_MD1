...
# Ruta dinámica segura
BASE_DIR = os.path.dirname(os.path.abspath(__file__))
ruta = os.path.join(BASE_DIR, "data", "anime.csv")

# Debug opcional
# st.write("Ruta actual:", ruta)

if not os.path.exists(ruta):
    st.error(f"❌ No existe el archivo en: {ruta}")
    st.stop()
